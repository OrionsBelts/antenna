...
- wget -nv https://golang.org/dl/go1.16.3.linux-amd64.tar.gz -O /tmp/go1.16.3.tar.gz && rm -rf /usr/local/go && tar -zxf /tmp/go1.16.3.tar.gz -C /usr/local && export PATH=$PATH:/usr/local/go/bin && export GOPATH=$HOME/go
